...
const translations = {
  ...
  es: {
    ...
    quotes: {
      ...
      noClientWarning: 'La visita vinculada no tiene cliente asignado. Crea uno para un mejor registro del trabajo.',
      createClientFirst: 'Crear Cliente Primero',
      continueWithoutClient: 'Continuar de Todos Modos',
      jobCreated: 'Trabajo creado', viewJob: 'Ver Trabajo',
