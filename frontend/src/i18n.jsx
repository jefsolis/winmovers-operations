...
const translations = {
  en: {
    ...
    visits: {
      ...
      fillSurvey: '+ Fill Survey', viewSurvey: 'View Survey', survey: 'Survey', noSurvey: 'No survey filled yet.',
    ...
    surveys: {
      ...
      surveyNumber: 'Survey #', fillSurvey: '+ Fill Survey', viewSurvey: 'View Survey',
      backToVisit: '← Back to Visit', createSurvey: 'Create Survey', editSurvey: 'Edit Survey',
      autoAssigned: 'Survey number will be auto-assigned',
      surveyInfo: 'Survey Information',
      surveyDate: 'Survey Date', surveyorName: 'Surveyor Name', totalCf: 'Total Cubic Feet',
      ...
      room: 'Room', description: 'Description', qty: 'QTY', cfPerItem: 'CF / Item', totalCfCol: 'Total CF',
      addItem: '+ Add Item', removeItem: 'Remove',
      addRoom: 'Add Room Section', roomSection: 'Room',
      grandTotal: 'Grand Total (Cubic Feet)',
      ...
      rooms: {
        ...
        STUDY_OFFICE: 'Study / Office', GARAGE: 'Garage', GARDEN: 'Garden / Terrace',
        OTHER: 'Other',
      },
    },
  },
  es: {
    ...
    visits: {
      ...
      fillSurvey: '+ Llenar Levantamiento', viewSurvey: 'Ver Levantamiento', survey: 'Levantamiento', noSurvey: 'Aún no hay levantamiento.',
    ...
    surveys: {
      title: 'Levantamiento de Pies Cúbicos', newSurvey: '+ Nuevo Levantamiento',
      surveyNumber: 'Levantamiento #', fillSurvey: '+ Llenar Levantamiento', viewSurvey: 'Ver Levantamiento',
      backToVisit: '← Volver a la Visita', createSurvey: 'Crear Levantamiento', editSurvey: 'Editar Levantamiento',
      autoAssigned: 'El número de levantamiento se asignará automáticamente',
      surveyInfo: 'Información del Levantamiento',
      surveyDate: 'Fecha del Levantamiento', surveyorName: 'Nombre del Inspector', totalCf: 'Total Pies Cúbicos',
      ...
      room: 'Habitación', description: 'Descripción', qty: 'CANT', cfPerItem: 'PC / Artículo', totalCfCol: 'Total PC',
      addItem: '+ Agregar Artículo', removeItem: 'Eliminar',
      addRoom: 'Agregar Sección', roomSection: 'Habitación',
      grandTotal: 'Total General (Pies Cúbicos)',
      noItems: 'Aún no se han agregado artículos.',
      noSurveyYet: 'Aún no hay levantamiento.',
      deleteConfirm: '¿Eliminar levantamiento {{num}}? Esta acción no se puede deshacer.',
      linkedVisit: 'Visita Vinculada',
      rooms: {
        LIVING_ROOM: 'Sala de Estar', DINING_ROOM: 'Comedor', KITCHEN: 'Cocina',
        MASTER_BEDROOM: 'Habitación Principal', BEDROOM_2: 'Habitación 2', BEDROOM_3: 'Habitación 3',
        STUDY_OFFICE: 'Estudio / Oficina', GARAGE: 'Garaje / Cochera', GARDEN: 'Jardín / Terraza',
        OTHER: 'Otros',
      },
    },
  },
