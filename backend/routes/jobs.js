...
router.post("/", forbidBodegaWrite, async (req, res, next) => {
  try {
    ...
    const data = {
      ...
      bultos:         bultos         != null && bultos         !== '' ? parseInt(bultos)        : null,
      personalCount:  personalCount  != null && personalCount  !== '' ? parseInt(personalCount) : null,
  ...
  try {
    ...
    const job = await getPrisma().job.update({
      ...
      data: {
        ...
        bultos:         bultos          !== undefined ? (bultos != null && bultos !== '' ? parseInt(bultos) : null)                        : undefined,
        personalCount:  personalCount   !== undefined ? (personalCount != null && personalCount !== '' ? parseInt(personalCount) : null)          : undefined,
